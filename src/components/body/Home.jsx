...
import { homeContest } from "../Data/homeInput.js";


const Home = () => {
    const [homeInputs, setHomeInputs] = useState(homeContest);

  // Handle Input Change
  const handleInputChange = (index, newValue) => {
    const updatedInputs = [...homeInputs];
    updatedInputs[index].inputVal = newValue;
    ...
    <section className="bg-white w-full max-w-[28rem] h-[698px] overflow-y-auto rounded-md shadow-md">
      ...
      <div className="flex flex-col items-center font-sans font-medium px-4">
        ...
        <div className="w-full flex flex-col gap-2">
          {homeInputs.map((challenge, index) => (
            <HomeInput
              key={index}
              data={challenge}
              index={index}
...
// const initialData = [
//   { title: "Target Price", inputVal: "1470.45", buttonText: "INR" },
//   { title: "Stop Loss", inputVal: "1430.45", buttonText: "INR" },
//   { title: "Expiring by", inputVal: "23 Mar 2024", buttonText: dateIcon },
// ];

// const Home = () => {
//   const [homeInputs, setHomeInputs] = useState(initialData);
...
//           {/* Attachments */}
//           <div className="flex justify-end gap-3 mt-3">
//             {[docIcon, gallIcon, gifIcon, EmojiIcon].map((icon, i) => (
//               <button key={i} className="hover:bg-gray-200 rounded-full p-2">
